...
#ifndef _NETAPP_LIB_H    /* Guard against multiple inclusion */
#define _NETAPP_LIB_H
...
extern "C" {
    ...
    /**************************************************************************
      ...
      @Description
        The SDDP IDENTIFY message is sent when the TV is power ON/OFF.
        This functon helps to create the header of SDDP IDENTIFY.
    ...
    /**************************************************************************
      @Function
        char * get_http_request_body(char * requestMsg)
